...
# Directories
train_directory = r"D:\ytl\CYCU\專題\weed\110.8.20\Corn August\378x504" # It should contain the xml files with bounding boxes
test_directory = r"D:\ytl\CYCU\專題\weed\110.8.20\Corn August\378x504" # It should contain the xml files with bounding boxes
